...
#load data
#######################################################
pbmc<-readRDS("14sample_fil_Bcell_pbmc_reclusteringpbmc_pure.rds") #this file can be find in figureshare or Zenodo
...
pdf(file=paste0("Figure_",Sys.Date(),"B_cell_plot_cell_trajectory_dbscan_puro1_LR_MN.pdf"))
